...
class AssetLoaderTest {
    ...
    void shouldLoadAssetFromBOM(String bomSuffix) {
        ...
        assertThat(actual.components()).contains(
                ...
                new Component(null, "slf4j-api", "2.0.13", "https://github.com/qos-ch/slf4j/slf4j-parent/slf4j-api", "pkg:maven/org.slf4j/slf4j-api@2.0.13?type=jar", ImmutableSet.of(
