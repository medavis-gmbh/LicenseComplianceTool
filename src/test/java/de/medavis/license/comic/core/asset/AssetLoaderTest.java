...
public class AssetLoaderTest {
    ...
    public void shouldLoadAssetFromBOM() {
        ...
        assertThat(actual.components()).containsExactlyInAnyOrder(
                new Component("ch.qos.logback", "logback-classic", "1.2.11", "https://github.com/ceki/logback", Set.of(
                ...
                new Component("ch.qos.logback", "logback-core", "1.2.11", "https://github.com/ceki/logback", Set.of(
                        new License("EPL-1.0", null),
                        new License("GNU Lesser General Public License", "http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html")
                )),
                new Component("org.slf4j", "slf4j-api", "1.7.32", "https://github.com/qos-ch/slf4j",
                        Set.of(new License("MIT", "https://opensource.org/licenses/MIT")))
        );
    }
}
