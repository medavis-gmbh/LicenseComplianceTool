...
import de.medavis.license.comic.jenkins.config.ManifestGlobalConfiguration;

import static de.medavis.license.comic.core.creator.Format.PDF;
...
public class CreateManifestBuilder extends Builder implements SimpleBuildStep {
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return de.medavis.license.comic.jenkins.create.Messages.CreateManifestBuilder_DescriptorImpl_displayName();
        }

        private FormValidation checkIfNotEmpty(String value) {
            return (Strings.isNullOrEmpty(value))
                    ? FormValidation.error(de.medavis.license.comic.jenkins.create.Messages.CreateManifestBuilder_DescriptorImpl_error_missingValue())
                    : FormValidation.ok();
        }
    }
