...
=== Create manifest
This build step creates a component manifest file based on an input SBOM and the global configuration. You can use it in scripted or declarative pipelines as well as freestyle jobs.
